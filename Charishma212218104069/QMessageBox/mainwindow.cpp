...
{
    QMessageBox::StandardButton reply= QMessageBox::question(this,"Charishma","Do You Like Apples",QMessageBox::Yes|QMessageBox::No);
...
{
    QMessageBox::StandardButton reply= QMessageBox::question(this," Charishma","this is a custom message",QMessageBox::Yes|QMessageBox::No|QMessageBox::YesAll|QMessageBox::NoAll);
    if(reply==QMessageBox::Yes)
